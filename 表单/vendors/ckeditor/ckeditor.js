...
(function () {
    ...
    CKEDITOR.dtd = function () {
        var b = CKEDITOR.tools.extend, c = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, h = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, f = {}, j = {"#": 1},
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var i =
                            this.$.getBoundingClientRect(), l = h.$.documentElement, n = l.clientTop || f.$.clientTop || 0,
                        o = l.clientLeft || f.$.clientLeft || 0, q = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function () {
        function b(a, b) {
            ...
            d = c.endContainer;
            var o = c.startOffset, e = c.endOffset, k, g = this.guard, p = this.type,
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, d = CKEDITOR.dom.walker.whitespaces(),
    ...
    (function () {
        ...
        var e = function (a) {
                ...
                u: 1,
                "var": 1
            }, f = CKEDITOR.dom.walker.bogus(), j = new CKEDITOR.dom.walker.whitespaces,
            i = new CKEDITOR.dom.walker.bookmark, l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var b = this.startContainer, c = this.endContainer, d = this.startOffset, g = this.endOffset,
                    p = this.collapsed, e, h;
                ...
                if (!this.collapsed) {
                    var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), g = this.startContainer, f = this.endContainer,
                        e = this.startOffset, h = this.endOffset, m = 1, i = 1;
            ...
            moveToPosition: function (a, b) {
                ...
                var b =
                    ...
                    c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, g = c.block, f = null;
    ...
    (function () {
        ...
        var a = /^[\r\n\t ]+$/, e = CKEDITOR.dom.walker.bookmark(false, true),
            d = CKEDITOR.dom.walker.whitespaces(true), h = function (a) {
                return e(a) && d(a)
            };
        b.prototype = {
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b,
                ...
                var d = [], f = !c && this._.rules, h = this._.transformations, p = e(this),
                    k = this.editor && this.editor.config.protectedSource, m = false;
        ...
        CKEDITOR.lang = {
            languages: {
                ...
                var a = this.languages, c = c || navigator.userLanguage || navigator.language || b,
                    e = c.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), d = e[1], e = e[2];
    ...
    CKEDITOR.ui.prototype = {
        add: function (b, c, a) {
            ...
            var c = this.items[b], a = c && this._.handlers[c.type],
                e = c && c.command && this.editor.getCommand(c.command), a = a && a.create.apply(this, c.args);
            this.instances[b] = a;
            e && e.uiItems.push(a);
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var k in c) {
                    ...
                    if (m && !a.lang[k]) {
                        ...
                        if (!o.langEntries ||
                            !o.langEntries[i]) f.push(CKEDITOR.getUrl(o.path + "lang/" + i + ".js")); else {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            remove: function () {
                ...
                var c = this.parent.children, a = CKEDITOR.tools.indexOf(c, this), e = b.previous = this.previous,
                    d = b.next = this.next;
                e && (e.next = b);
                d && (d.previous = b);
                c[a] = b;
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (d, h, f) {
            ...
            var k = new CKEDITOR.htmlParser,
                ...
                p = [], v = [], u = g, m = g.name == "textarea", E = g.name == "pre";
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (a) {
            ...
            a.on("toHtml", function (b) {
                var b = b.data, d = b.dataValue, d = m(d, a), d = k(d, G), d = q(d), d = k(d, I),
                    d = d.replace(Q, "$1cke:$2"), d = d.replace(F, "<cke:$1$2></cke:$1>"),
                    d = CKEDITOR.env.opera ? d : d.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
                    e = b.context || a.editable().getName(), f;
        ...
        var E = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", r = CKEDITOR.dtd,
            x = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            z = CKEDITOR.tools.extend({}, r.$blockLimit, r.$block),
            s = {elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]]}, C = {
        ...
        var t = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            G = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, D = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            Q = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            L = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, F = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
            var i = this.container, l = this.ui.space("contents"),
    ...
    (function () {
        function b(b) {
            var c = b.editor, d = c.editable(), g = b.data.path, e = g.blockLimit, f = b.data.selection.getRanges()[0],
        ...
        function d(b) {
            var c, d = b.getRanges()[0], b = b.root, g = d.startPath(), e = {table: 1, ul: 1, ol: 1, dl: 1},
        ...
        var j = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
            i = CKEDITOR.dom.walker.whitespaces(true), l = CKEDITOR.dom.walker.bookmark(false, true);
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            e.on("contentDom", function () {
                var a = e.document, d = CKEDITOR.document, g = e.editable(), f = a.getBody(),
                    k = a.getDocumentElement(), i = g.isInline(), j;
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    if (o) {
                        var c = CKEDITOR.dom.walker.whitespaces(true), d = /\ufeff|\u00a0/,
    ...
    (function () {
        ...
        function o(a) {
            var b = this._.definition, c = b.attributes, b = b.styles, d = m(this)[a.getName()],
        ...
        var r = {
                ...
                audio: 1,
                video: 1
            }, z = /\s*(?:;\s*|$)/, s = /#\((.+?)\)/g, C = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var c = this.$.parentNode, a = c.childNodes.length, e = this.getLength(), d = this.getDocument(),
    ...
    (function () {
        function b(a, b, c) {
            var h = a.serializable, f = b[c ? "endContainer" : "startContainer"], j = c ? "endOffset" : "startOffset",
...
*/
    ...
    (function () {
        ...
        function U(a) {
            function b(b) {
                var c = a.getSize(), h = CKEDITOR.document.getWindow().getViewPaneSize(), o = b.data.$.screenX,
                    i = b.data.$.screenY, n = o - d.x, l = i - d.y;
                d = {x: o, y: i};
                e.x += n;
                e.y += l;
        ...
        function V(a) {
            ...
            function d(e) {
                var d = "rtl" == k.lang.dir, i = o.width, D = o.height,
                    E = i + (e.data.$.screenX - b) * (d ? -1 : 1) * (a._.moved ? 1 : 2),
                    n = D + (e.data.$.screenY - c) * (a._.moved ? 1 : 2), x = a._.element.getFirst(),
                    x = d && x.getComputedStyle("right"), y = a.getPosition();
        ...
        function J(a) {
            var b = CKEDITOR.document.getWindow(), c = a.config, d = c.dialog_backgroundCoverColor || "white",
                e = c.dialog_backgroundCoverOpacity, g = c.baseFloatZIndex, c = CKEDITOR.tools.genKey(d, e, g),
                f = w[c];
        ...
        (function () {
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, d, e, g, f) {
                    if (!(4 > arguments.length)) {
                        var k = (d.call ? d(b) : d) || "div", m = ["<", k, " "], j = (e && e.call ? e(b) : e) || {},
                    ...
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var g = this._.children = b, f = e && e.widths || null, k = e && e.height || null, m,
                            j = {role: "presentation"};
                    ...
                    if (j && h) {
                        if (a && (a.is("li") ||
                            ...
                            var i = !a.hasPrevious(), m = !a.hasNext(), k = e.getSelection(), g = k.createBookmarks(),
                                ...
                                l = d.getDirection(1) != j, e = e.config.enterMode != CKEDITOR.ENTER_BR || l || n || h;
    ...
    (function () {
        ...
        var t = CKEDITOR.dom.walker.whitespaces(!0), u = CKEDITOR.dom.walker.bookmark(!1, !0),
    ...
    (function () {
        ...
        function da(a) {
            ...
            q(d, {
                ...
                place: function () {
                    var b = a.view, c = a.editable, d = a.trigger, e = d.upper, g = d.lower, i = e || g,
                        l = i.getParent(), k = {};
                    this.trigger = d;
                    e && o(a, e, !0);
                    g && o(a, g, !0);
        ...
        var q = CKEDITOR.tools.extend, K = CKEDITOR.dom.element, B = K.createFromHtml, n = CKEDITOR.env,
            w = CKEDITOR.dtd, D = 128, W = 64, M = 32, G = 16, ba = 8, x = 4, y = 2, s = 1, E = " ", Y = w.$listItem,
            ga = w.$tableContent, ea = q({}, w.$nonEditable, w.$empty), T = w.$block, Z = 100,
