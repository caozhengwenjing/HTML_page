...
!function (e, t) {
    ...
    var s = {}, l = "tinymce/dom/Sizzle", c = "tinymce/html/Styles", u = "tinymce/dom/EventUtils",
        d = "tinymce/dom/TreeWalker", f = "tinymce/util/Tools", p = "tinymce/dom/Range", m = "tinymce/html/Entities",
        h = "tinymce/Env", g = "tinymce/dom/DOMUtils", v = "tinymce/dom/ScriptLoader", y = "tinymce/AddOnManager",
        b = "tinymce/html/Node", C = "tinymce/html/Schema", x = "tinymce/html/SaxParser", w = "tinymce/html/DomParser",
        _ = "tinymce/html/Writer", N = "tinymce/html/Serializer", k = "tinymce/dom/Serializer",
        E = "tinymce/dom/TridentSelection", S = "tinymce/util/VK", T = "tinymce/dom/ControlSelection",
        R = "tinymce/dom/Selection", A = "tinymce/dom/RangeUtils", B = "tinymce/Formatter", H = "tinymce/UndoManager",
        M = "tinymce/EnterKey", D = "tinymce/ForceBlocks", L = "tinymce/EditorCommands", P = "tinymce/util/URI",
        O = "tinymce/util/Class", I = "tinymce/ui/Selector", F = "tinymce/ui/Collection", W = "tinymce/ui/DomUtils",
        z = "tinymce/ui/Control", V = "tinymce/ui/Factory", U = "tinymce/ui/Container", q = "tinymce/ui/DragHelper",
        j = "tinymce/ui/Scrollable", $ = "tinymce/ui/Panel", K = "tinymce/ui/Movable", G = "tinymce/ui/Resizable",
        Y = "tinymce/ui/FloatPanel", X = "tinymce/ui/KeyboardNavigation", J = "tinymce/ui/Window",
        Q = "tinymce/ui/MessageBox", Z = "tinymce/WindowManager", et = "tinymce/util/Quirks",
        tt = "tinymce/util/Observable", nt = "tinymce/Shortcuts", rt = "tinymce/Editor", it = "tinymce/util/I18n",
        ot = "tinymce/FocusManager", at = "tinymce/EditorManager", st = "tinymce/LegacyInput", lt = "tinymce/util/XHR",
        ct = "tinymce/util/JSON", ut = "tinymce/util/JSONRequest", dt = "tinymce/util/JSONP",
        ft = "tinymce/util/LocalStorage", pt = "tinymce/Compat", mt = "tinymce/ui/Layout",
        ht = "tinymce/ui/AbsoluteLayout", gt = "tinymce/ui/Tooltip", vt = "tinymce/ui/Widget", yt = "tinymce/ui/Button",
        bt = "tinymce/ui/ButtonGroup", Ct = "tinymce/ui/Checkbox", xt = "tinymce/ui/PanelButton",
        wt = "tinymce/ui/ColorButton", _t = "tinymce/ui/ComboBox", Nt = "tinymce/ui/Path",
        kt = "tinymce/ui/ElementPath", Et = "tinymce/ui/FormItem", St = "tinymce/ui/Form", Tt = "tinymce/ui/FieldSet",
        Rt = "tinymce/ui/FilePicker", At = "tinymce/ui/FitLayout", Bt = "tinymce/ui/FlexLayout",
        Ht = "tinymce/ui/FlowLayout", Mt = "tinymce/ui/FormatControls", Dt = "tinymce/ui/GridLayout",
        Lt = "tinymce/ui/Iframe", Pt = "tinymce/ui/Label", Ot = "tinymce/ui/Toolbar", It = "tinymce/ui/MenuBar",
        Ft = "tinymce/ui/MenuButton", Wt = "tinymce/ui/ListBox", zt = "tinymce/ui/MenuItem", Vt = "tinymce/ui/Menu",
        Ut = "tinymce/ui/Radio", qt = "tinymce/ui/ResizeHandle", jt = "tinymce/ui/Spacer",
        $t = "tinymce/ui/SplitButton", Kt = "tinymce/ui/StackLayout", Gt = "tinymce/ui/TabPanel",
        Yt = "tinymce/ui/TextBox", Xt = "tinymce/ui/Throbber";
    r(l, [], function () {
        function e(e, n, r, i) {
        ...
        function t(n) {
            ...
            function p(e, t) {
                var n = D[V], r = D[z], i = D[U], o = D[q], a = t.startContainer, s = t.startOffset, l = t.endContainer,
                    c = t.endOffset;
            ...
            function k(e) {
                ...
                for (o = C(D[V], D[z]), a = D[q] - D[z]; o && a > 0;) s = o.nextSibling, l = H(o, e), t && t.appendChild(l), --a, o = s;
                return e != O && D.collapse(F), t
            }

            function E(e, t) {
                var n, i, o, a, s, l;
                if (t != I && (n = r()), i = R(e, t), n && n.appendChild(i), o = $(e), a = o - D[z], 0 >= a) return t != O && (D.setEndBefore(e), D.collapse(W)), n;
            ...
            function S(e, t) {
                var n, i, o, a, s, l;
                for (t != I && (n = r()), o = A(e, t), n && n.appendChild(o), i = $(e), ++i, a = D[q] - i, o = e.nextSibling; o && a > 0;) s = o.nextSibling, l = H(o, t), n && n.appendChild(l), --a, o = s;
            ...
            var D = this, L = n.doc, P = 0, O = 1, I = 2, F = !0, W = !1, z = "startOffset", V = "startContainer",
        ...
        function c(e, t) {
            var i = this, o;
            i.doc = e, i.win = window, i.files = {}, i.counter = 0, i.stdMode = !g || e.documentMode >= 8, i.boxModel = !g || "CSS1Compat" == e.compatMode || i.stdMode, i.hasOuterHTML = "outerHTML" in e.createElement("a"), i.settings = t = m({
                keep_values: !1,
                hex_colors: 1
        ...
        var u = l.each, d = l.is, f = l.grep, p = l.trim, m = l.extend, h = s.webkit, g = s.ie, v = /^([a-z0-9],?)+$/i,
            y = /^[ \t\r\n]*$/,
        ...
        return function (e) {
            ...
            function d(e) {
                var n, r, o, a, s, c, d, f, p, m, h, g, y, C, x, w, _, N, k,
                    E = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/,
                    S = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/, T = /[*?+]/;
                if (e) for (e = t(e, ","), v["@"] && (w = v["@"].attributes, _ = v["@"].attributesOrder), n = 0, r = e.length; r > n; n++) if (s = E.exec(e[n])) {
                    ...
                    if (f) for (f = t(f, "|"), o = 0, a = f.length; a > o; o++) if (s = S.exec(f[o])) {
                        ...
                        C && ("=" === C && (c.attributesDefault = c.attributesDefault || [], c.attributesDefault.push({
                            ...
                            name: m,
                            value: k
                        }), d.forcedValue = k), "<" === C && (d.validValues = i(k, "?"))), T.test(m) ? (c.attributePatterns = c.attributePatterns || [], d.pattern = u(m), c.attributePatterns.push(d)) : (g[m] || y.push(m), g[m] = d)
                    }
        ...
        return function (n, i) {
            ...
            n = n || {}, o.schema = i = i || new e, n.fix_self_closing !== !1 && (n.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var a = this, s, l = 0, c, u, d = [], f, p, m, h, g, v, y, b, C, x, w, _, N, k, E, S, T, R, A, B, H, M,
                    D, L, P, O = 0, I = t.decode, F;
                    ...
                    if (l < s.index && a.text(I(e.substr(l, s.index - l))), c = s[6]) c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), r(c); else if (c = s[7]) {
                        if (c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), C = c in y, F && H[c] && d.length > 0 && d[d.length - 1].name === c && r(c), !x || (w = i.getElementRule(c))) {
                            if (_ = !0, x && (E = w.attributes, S = w.attributePatterns), (k = s[8]) ? (g = -1 !== k.indexOf("data-mce-type"), g && v && (_ = !1), f = [], f.map = {}, k.replace(D, o)) : (f = [], f.map = {}), x && !g) {
                                if (T = w.attributesRequired, R = w.attributesDefault, A = w.attributesForced, B = w.removeEmptyAttrs, B && !f.length && (_ = !1), A) for (p = A.length; p--;) N = A[p], h = N.name, P = N.value, "{$uid}" === P && (P = "mce_" + O++), f.map[h] = P, f.push({
                                    name: h,
                                    value: P
                                });
                                if (R) for (p = R.length; p--;) N = R[p], h = N.name, h in f.map || (P = N.value, "{$uid}" === P && (P = "mce_" + O++), f.map[h] = P, f.push({
                                    name: h,
                                    value: P
                                }));
                                if (T) {
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate" in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                if (o = o || {}, p = {}, m = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, S = r.validate, I = "forced_root_block" in o ? o.forced_root_block : r.forced_root_block, L = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, H = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, D = /^[ \t\r\n]+$/, v = new n({
                    validate: S, self_closing_elements: g(l.getSelfClosingElements()), cdata: function (e) {
                        ...
                        if (o = S ? l.getElementRule(e) : {}) {
                            for (r = u(o.outputName || e, 1), r.attributes = t, r.shortEnded = n, b.append(r), s = P[b.name], s && P[r.name] && !s[r.name] && A.push(r), i = f.length; i--;) a = f[i].name, a in t.map && (k = m[a], k ? k.push(r) : m[a] = [r]);
                        ...
                        if (r = S ? l.getElementRule(t) : {}) {
                            if (T[t] && !B) {
                                ...
                                if (n = b.lastChild, n && 3 === n.type) if (i = n.value.replace(H, ""), i.length > 0) n.value = i, n = n.prev; else for (o = n.prev, n.remove(), n = o; n && 3 === n.type;) i = n.value, o = n.prev, (0 === i.length || D.test(i)) && (n.remove(), n = o), n = o
                            }
                            if (B && L[t] && (B = !1), (r.removeEmpty || r.paddEmpty) && b.isEmpty(O)) if (r.paddEmpty) b.empty().append(new e("#text", "3")).value = "\xa0"; else if (!b.attributes.map.name && !b.attributes.map.id) return a = b.parent, b.empty().remove(), b = a, void 0;
                            b = b.parent
                        }
                    }
                    ...
                    for (E in p) {
                        for (k = d[E], C = p[E], _ = C.length; _--;) C[_].parent || C.splice(_, 1);
                        for (x = 0, w = k.length; w > x; x++) k[x](C, E, o)
                    }
                    for (x = 0, w = f.length; w > x; x++) if (k = f[x], k.name in m) {
                        for (C = m[k.name], _ = C.length; _--;) C[_].parent || C.splice(_, 1);
                        for (_ = 0, N = k.callbacks.length; N > _; _++) k.callbacks[_](C, k.name, o)
                    }
                }
                return y
        ...
        return function (r, i) {
            ...
            function a(t) {
                var n, r;
                n = t.screenX - E, r = t.screenY - S, D = n * N[2] + A, L = r * N[3] + B, D = 5 > D ? 5 : D, L = 5 > L ? 5 : L, (e.modifierPressed(t) || "IMG" == x.nodeName && 0 !== N[2] * N[3]) && (D = Math.round(L / H), L = Math.round(D * H)), b.setStyles(w, {
                    width: D,
                    height: L
                }), N[2] < 0 && w.clientWidth <= D && b.setStyle(w, "left", T + (A - D)), N[3] < 0 && w.clientHeight <= L && b.setStyle(w, "top", R + (B - L)), M || (i.fire("ObjectResizeStart", {
                    target: x,
                    width: A,
                    height: B
                }), M = !0)
            ...
            function s() {
                ...
                M = !1, e("width", D), e("height", L), b.unbind(P, "mousemove", a), b.unbind(P, "mouseup", s), O != P && (b.unbind(O, "mousemove", a), b.unbind(O, "mouseup", s)), b.remove(w), I && "TABLE" != x.nodeName || l(x), i.fire("ObjectResized", {
                    target: x,
                    width: D,
                    height: L
                }), i.nodeChanged()
            ...
            function l(e, t, n) {
                ...
                r = b.getPos(e, p), T = r.x, R = r.y, f = e.getBoundingClientRect(), l = f.width || f.right - f.left, u = f.height || f.bottom - f.top, x != e && (h(), x = e, D = L = 0), d = i.fire("ObjectSelected", {target: e}), o(e) && !d.isDefaultPrevented() ? C(_, function (e, r) {
                    function o(t) {
                        M = !0, E = t.screenX, S = t.screenY, A = x.clientWidth, B = x.clientHeight, H = B / A, N = e, w = x.cloneNode(!0), b.addClass(w, "mce-clonedresizable"), w.contentEditable = !1, w.unSelectabe = !0, b.setStyles(w, {
                            left: T,
                            top: R,
                            margin: 0
            ...
            var b = i.dom, C = t.each, x, w, _, N, k, E, S, T, R, A, B, H, M, D, L, P = i.getDoc(), O = document,
                I = n.ie && n.ie < 11;
            _ = {
                n: [.5, 0, 0, -1],
                e: [1, .5, 1, 0],
                ...
                function t(t) {
                    ...
                    function l(t, n) {
                        ...
                        for (n = n || c, r = new e(n, f.getParent(n.parentNode, f.isBlock) || p); m = r[t ? "prev" : "next"]();) {
                            if (3 === m.nodeType && m.nodeValue.length > 0) return c = m, u = t ? m.nodeValue.length : 0, i = !0, void 0;
                    ...
                    if (c = r[(t ? "start" : "end") + "Container"], u = r[(t ? "start" : "end") + "Offset"], h = f.schema.getNonEmptyElements(), 9 === c.nodeType && (c = f.getRoot(), u = 0), c === p) {
                        if (t && (m = c.childNodes[u > 0 ? u - 1 : 0], m && (g = m.nodeName.toLowerCase(), h[m.nodeName] || "TABLE" == m.nodeName))) return;
        ...
        return function (r) {
            ...
            function p(t, n, o) {
                ...
                if (h) if (o) o.nodeType ? (y = I.createRng(), y.setStartBefore(o), y.setEndAfter(o), d(T(y, m), null, !0)) : d(o, null, !0); else if (b && h.inline && !I.select("td.mce-item-selected,th.mce-item-selected").length) L("apply", t, n); else {
            ...
            function m(e, t, n) {
                ...
                function f(e) {
                    var t, n;
                    e = T(e, p, G), m.split && (t = D(e, G), n = D(e), t != n ? (/^(TR|TD)$/.test(t.nodeName) && t.firstChild && (t = "TD" == t.nodeName ? t.firstChild || t : t.firstChild.firstChild || t), t = S(t, "span", {
                        id: "_start",
                        "data-mce-type": "bookmark"
                    }), n = S(n, "span", {
                        id: "_end",
            ...
            function T(t, n, a) {
                function s(e) {
                    ...
                    var r, i, o, a, s;
                    if (r = i = e ? g : y, a = e ? "previousSibling" : "nextSibling", s = I.getRoot(), 3 == r.nodeType && !E(r) && (e ? v > 0 : b < r.nodeValue.length)) return r;
                    for (; ;) {
            ...
            function L(t, n, o) {
                ...
                function h() {
                    ...
                    if (d) if (l) s = F.getBookmark(), e.collapse(!0), e = T(e, c(n), !0), e = W.split(e), m(n, o, e), F.moveToBookmark(s); else {
        ...
        return function (t) {
            function r(r) {
                ...
                function h(t) {
                    ...
                    if ("TABLE" === E.nodeName || E.previousSibling && "TABLE" == E.previousSibling.nodeName) return O && !t || !O && t;
                ...
                function g(e, n) {
                    ...
                    if (o = i.getParent(e, i.isBlock), d = t.getBody().nodeName.toLowerCase(), !o || !u(o)) {
                        if (o = o || k, !o.hasChildNodes()) return r = i.create(f), o.appendChild(r), _.setStart(r, 0), _.setEnd(r, 0), r;
                ...
                function y() {
                    for (var t = new e(E, T), n; n = t.next();) if (c[n.nodeName.toLowerCase()] || n.length > 0) return !0
                }
                ...
                if (!r.isDefaultPrevented() && (E = _.startContainer, S = _.startOffset, P = (a.force_p_newlines ? "p" : "") || a.forced_root_block, P = P ? P.toUpperCase() : "", R = i.doc.documentMode, A = r.shiftKey, 1 == E.nodeType && E.hasChildNodes() && (O = S > E.childNodes.length - 1, E = E.childNodes[Math.min(S, E.childNodes.length - 1)] || E, S = O && 3 == E.nodeType ? E.nodeValue.length : 0), k = x(E))) {
                    if (s.beforeChange(), !i.isBlock(k) && k != i.getRoot()) return (!P || A) && b(), void 0;
            ...
            var i = t.dom, o = t.selection, a = t.settings, s = t.undoManager, l = t.schema,
        ...
        return function (n) {
            ...
            o(this, {execCommand: r, queryCommandState: p, queryCommandValue: m, addCommands: h}), h({
            ...
            o = /^\s*|\s*$/g, a, s = e.extend({
                init: function (e) {
                    ...
                    for (n = n || this._selectors, r = 0, i = n.length; i > r; r++) {
                        for (s = n[r], a = s.length, h = e, m = 0, o = a - 1; o >= 0; o--) for (u = s[o]; h;) {
                            for (u.psuedo && (p = h.parent().items(), d = t.inArray(h, p), f = p.length), l = 0, c = u.length; c > l; l++) if (!u[l](h, d, f)) {
                                l = c + 1;
                                break
                            }
                            if (l === c) {
        ...
        return function (t) {
            function n() {
                if (!m) if (m = [], d.find) d.find("*").each(function (e) {
                    e.canFocus && m.push(e.getEl())
                }); else for (var e = d.getEl().getElementsByTagName("*"), t = 0; t < e.length; t++) e[t].id && e[t] && m.push(e[t])
            }
        ...
        return function (a) {
            ...
            var P = o.each, O = e.BACKSPACE, I = e.DELETE, F = a.dom, W = a.selection, z = a.settings, V = a.parser,
                U = a.serializer, q = i.gecko, j = i.ie, $ = i.webkit;
        ...
        var k = e.DOM, E = n.ThemeManager, S = n.PluginManager, T = C.extend, R = C.each, A = C.explode, B = C.inArray,
            H = C.trim, M = C.resolve, D = m.Event, L = b.gecko, P = b.ie, O = b.opera;
        return N.prototype = {
            render: function () {
                function e() {
                ...
                if (!D.domLoaded) return k.bind(window, "ready", function () {
                    t.render()
                }), void 0;
                if (t.editorManager.settings = n, t.getElement() && b.contentEditable) {
                    ...
                    o && (t.formElement = o, n.hidden_input && !/TEXTAREA|INPUT/i.test(t.getElement().nodeName) && k.insertAfter(k.create("input", {
                        type: "hidden",
                        name: r
                ...
                if (n && t.initialized) return e = e || {}, e.save = !0, e.element = n, r = e.content = t.getContent(e), e.no_events || t.fire("SaveContent", e), r = e.content, /TEXTAREA|INPUT/i.test(n.nodeName) ? n.value = r : (n.innerHTML = r, (i = k.getParent(t.id, "form")) && R(i.elements, function (e) {
        ...
        var c = n.DOM, u = o.explode, d = o.each, f = o.extend, p = 0, m, h = {
            majorVersion: "4",
            minorVersion: "0.5",
            ...
            remove: function (e) {
                ...
                if (e) {
                    ...
                    if (t.activeEditor == i && (t.activeEditor = r[0]), i && !i.removed) return i.remove(), i.destroy(), t.fire("RemoveEditor", {editor: i}), r.length || c.unbind(window, "beforeunload", m), i
        ...
        var i, o, a, s, l, c;
        return window.localStorage ? localStorage : (l = "tinymce", o = document.documentElement, c = !!o.addBehavior, c && o.addBehavior("#default#userData"), i = {
            key: function (e) {
                return s[e]
            }, getItem: function (e) {
        ...
        return e.extend({
            Defaults: {delimiter: "\xbb"}, init: function (e) {
                var t = this;
        ...
        return e.extend({
            recalc: function (e) {
                ...
                if (x = {}, x[k] = 0 > d ? i[k] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[W], x[H] = i[R] - d, x[z] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
                    for (C = d / u, t = 0, n = v.length; n > t; t++) p = v[t], m = p.layoutRect(), b = m[S], y = m[k] + Math.ceil(m.flex * C), y > b ? (d -= m[S] - m[k], u -= m.flex, m.flex = 0, m.maxFlexSize = b) : m.maxFlexSize = 0;
                    for (C = d / u, w = o[T], x = {}, 0 === u && ("end" == l ? w = d + o[T] : "center" == l ? (w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])) : "justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[M] = o[I], t = 0, n = r.length; n > t; t++) p = r[t], m = p.layoutRect(), y = m.maxFlexSize || m[k], "center" === s ? x[M] = Math.round(i[D] / 2 - m[L] / 2) : "stretch" === s ? (x[L] = V(m[P] || 0, i[D] - o[I] - o[F]), x[M] = o[I]) : "end" === s && (x[M] = i[D] - m[L] - o.top), m.flex > 0 && (y += Math.ceil(m.flex * C)), x[N] = y, x[E] = w, p.layoutRect(x), p.recalc && p.recalc(), w += y + c
        ...
        return e.extend({
            recalc: function (e) {
                var t = e.settings, n, r, i, o, a, s, l, c, u, d, f, p, m, h, g, v, y, b, C, x, w, _, N = [], k = [], E,
                    S, T, R, A, B;
